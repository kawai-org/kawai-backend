...
// func HandlerCalendar(db *mongo.Database, simpleEvent model.SimpleEvent) (*calendar.Event, error) {
// 	ctx := context.Background()

// 	// Fungsi ini akan otomatis mengambil dari gettoken.go karena satu package
